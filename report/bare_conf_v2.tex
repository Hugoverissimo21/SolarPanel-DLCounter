...
\begin{figure}[H]
    ...
    \caption{Eu removia esta imagem e usava apenas a seguinte com label em cada imagem do estilo D | roof, S | S-unknown}
...
\begin{figure}[H]
    ...
    \caption{Eu retirava esta imagem e tentava combinar a informação do número de thermal solar e photovoltaic em cada um dos gráficos seguintes (respectivamente).}
