...
% INDICAR ALGURES QUE EVENVOLVEU A TRANS DE SEG MASKS PARA BOUNDING BOXES
...
\end{comment}
%JP: Passei esta parte acima para a intro deste capt, porque já tinha escrito isto no primeiro modelo. Aqui poderá referir-se que foi selecionado a partir de 4 folds em vez de 3, já que havia alguma margem computacional para aproveitar.
